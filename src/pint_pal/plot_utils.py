...
def summary_plots(fitter, title = None, legends = False, save = False, avg = True, whitened = True):
    ...
    plot_dmx_time(fitter, savedmx = "dmxparse.out", legend = False, title = False, axs = ax4, figsize=(12,3))
    k += 1
    ...
    for ii in range(4):
        ...
        if ii == 0:
            ...
            if 'dispersion_dmx' in fitter.model.get_components_by_category().keys():
                plot_dmx_time(fitter, savedmx = "dmxparse.out", legend = False, title = False, axs = ax3,  figsize=(8,2.5))
            else:
...
def plot_by_color(ax, x, y, err, bknds, rn_off, be_legend, be_format):
    ...
    if be_legend:
        ...
        label_names = {"327_ASP":        "ASP 327 MHz",
          ...
          "430_ASP":         "ASP 430 MHz",
          "430_PUPPI":       "PUPPI 430 MHz",
          "L-wide_ASP":      "ASP L-wide",
          ...
          "3GHz_YUPPI":      "YUPPI 3 GHz",
          "6GHz_YUPPI":      "YUPPI 6 GHz",
          "CHIME":           "CHIME",
           }
